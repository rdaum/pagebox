...
pub(crate) enum BTreeEvent {
    ...
    ParentFallbacks,
    LeftChases,
    FallbackRouteFailures,
    FallbackResolveFailures,
    ResolveCold,
...
pub struct BTreeDiagnosticStats {
    ...
    pub left_chases: u64,
    pub fallback_route_failures: u64,
    pub fallback_resolve_failures: u64,
...
impl BTreeStats {
    ...
    pub(crate) fn diagnostic_stats(&self) -> BTreeDiagnosticStats {
        BTreeDiagnosticStats {
            ...
            left_chases: self.events.get(BTreeEvent::LeftChases) as u64,
            fallback_route_failures: self.events.get(BTreeEvent::FallbackRouteFailures) as u64,
            fallback_resolve_failures: self.events.get(BTreeEvent::FallbackResolveFailures) as u64,
